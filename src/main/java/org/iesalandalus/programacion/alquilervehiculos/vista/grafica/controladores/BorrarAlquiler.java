...
public class BorrarAlquiler {
    ...
    void borrarAlquiler(ActionEvent event) {
    	...
    	try {
    		controladorMVC.borrar(controladorMVC.buscar(alquilerTemp));
			listaAlquiler.remove(alquilerTemp);
		} catch (Exception e) {
    	...
    	String error= "El alquiler se ha borrado correctamente";
